...
#define assert_ext_from_str_eq(s, val, msg) \
    do { \
        ...
        char* _a_e_f_s_e_msg; \
        asprintf_or(&_a_e_f_s_e_msg, "%s (%s)", msg, s) { \
...
#define assert_ext_from_str_neq(s, val, msg) \
    do { \
        ...
        asprintf_or(&_a_e_f_s_ne_msg, "%s (%s)", msg, s) { \
...
#define assert_ext_eq(a, b, msg) \
    do { \
        ...
        asprintf_or(&_a_e_e_msg, "%s: %s != %s", msg, _a_e_e_eval_repr_a, _a_e_e_eval_repr_b) { \
            fail("Allocation failed for failure message!"); \
        }\
...
#define assert_ext_neq(a, b, msg) \
    do { \
        ...
        asprintf_or(&_a_e_ne_msg, "%s: %s == %s", msg, _a_e_ne_eval_repr_a, _a_e_ne_eval_repr_b) { \
            fail("Allocation failed for failure message!"); \
        }\
